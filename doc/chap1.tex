...
\begin{myexample}[label=ex:sl2]{単純Lie代数：$\Lsl (2)$}
    $\character \mathbb{K} \neq 2$ とする．\exref{def:typeA}に倣って $\Lsl(2,\, \mathbb{K})$ の基底を
    \begin{align}
    ...
    \begin{enumerate}
        ...
        \begin{figure}[H]
            ...
            \begin{tikzcd}[row sep=large, column sep=large]
                &\mathfrak{g} \ar[rr, blue, "f"]\ar[dr, "p"'] & &\forall \textcolor{blue}{\mathfrak{h}} \ar[from=dl,red, dashed, "\exists! \overline{f}"'] \\
...
\begin{proof}
    ...
    \begin{center}
        \begin{tikzcd}[row sep=large, column sep=large]
            ...
            V/V_1 \ar[urr, red, dashed, "\exists! \overline{x}"] & &
        \end{tikzcd}
    \end{center}
