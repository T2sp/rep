...
\begin{proof}
	...
	\begin{proof}
		...
		このとき $f_0$ を適当に規格化して単位ベクトルにすることで $0 < \rpair{e}{f_0} < 1$ を充たすようにできる． 
		$f_i$ の直交性から $e = \sum_{i=0}^k \rpair{e}{f_i} f_i$ が成り立つので，
		\begin{align}
			1 = \rpair{e}{e} = \sum_{i=0}^k \rpair{e}{f_i}^2 = \rpair{e}{f_0} + \sum_{i=1}^k \rpair{e}{f_i}^2
		\end{align}
		が従い，
		\begin{align}
	...
	\begin{proof}
		...
		\end{align}
		でなくてはいけない．よってあり得るのは $(p,\, q) = (2,\, 2),\, (1,\, r),\, (r, 1)\WHERE r \in \mathbb{N}$ のみである．
	\end{proof}
	...
	\begin{proof}
		...
		$\mathfrak{U}$ の元の線型独立性から，$e,\, f,\, h$ は互いに正規直交し，$g \notin \Span_{\mathbb{R}} \{e,\, f,\, h\}$ である．\hyperref[lem:classification-step-4]{\textsf{\textbf{step 4}}}の証明から，
		...
		\end{align}
		が成り立ち，\hyperref[lem:classification-step-9]{\textsf{\textbf{step 9}}}の証明と全く同じ計算をすることで
		\begin{align}
		...
		\begin{align}
			...
			&= (p-1)^2\frac{\rpair{e_{p-1}}{g}^2}{\rpair{g}{g}} \\
			&= \frac{1}{4} \frac{2(p-1)^2}{p(p-1)} \\
