...
\begin{mydef}[label=def:tensor-alg]{テンソル代数}
	...
	\end{description}
\end{mydef}
\begin{myprop}[label=prop:unique-tensor-alg]{テンソル代数の一意性}
	\hyperref[def:tensor-alg]{テンソル代数}は，単位的結合代数の同型を除いて一意的に存在する．
\end{myprop}
\begin{proof}
	\begin{description}
...
\begin{mydef}[label=def:sym-alg]{対称代数}
	...
	\end{description}
\end{mydef}
\begin{myprop}[label=prop:unique-sym-alg]{対称代数の一意性}
	\hyperref[def:sym-alg]{対称代数}は，単位的可換結合代数の同型を除いて一意的に存在する．
\end{myprop}
\begin{proof}
	\begin{description}
...
\begin{mydef}[label=def:univ-env-alg]{普遍包絡代数}
	...
	\end{description}
\end{mydef}
\begin{myprop}[label=prop:unique-univ-env-alg]{普遍包絡代数の一意性}
	\hyperref[def:univ-env-alg]{普遍包絡代数}は，単位的結合代数の同型を除いて一意的に存在する．
\end{myprop}
\begin{proof}
	\begin{description}
